package com.example.fragmentlifecycleandcommunications.Content
...
object SongUtils {
    ...
    /**
     *  data class với 2 thuộc tính songTiltle và details
     */
    ...
    /**
     * thêm một Song vào danh sách SONG_ITEMS
     */
    private fun addItem(item: Song) {
        SONG_ITEMS.add(item)
    }
    /**
     * tạo ra một đối tượng Song mới dựa trên vị trí của bài hát trong danh sách
     */
